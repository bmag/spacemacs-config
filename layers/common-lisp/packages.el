...
(defun common-lisp/post-init-company ()
  (push '(company-slime company-capf company-dabbrev-code) company-backends-lisp-mode)
  (spacemacs|add-company-hook lisp-mode))
...
(defun common-lisp/init-slime ()
  (use-package slime
    ...
    :init
    (progn
      (spacemacs/register-repl 'slime 'slime-switch-to-output-buffer)
    ...
    (progn
      ...
      (dolist (binding '(("mc" . "compile")
                         ...
                         ("ms" . "slime")
                         ("mt" . "trace")))
        (spacemacs/declare-prefix-for-mode 'lisp-mode (car binding) (cdr binding))))))
